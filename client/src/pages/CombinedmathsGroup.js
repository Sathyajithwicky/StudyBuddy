...
const CombinedMathsGroup = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      id: 14,
      question:
        "What is the formula for the distance between two points (x₁,y₁) and (x₂,y₂)?",
      options: [
        "d = |x₂ - x₁| + |y₂ - y₁|",
        "d = √[(x₂ - x₁)² + (y₂ - y₁)²]",
        "d = (x₂ - x₁) × (y₂ - y₁)",
    ...
    },
    {
      id: 19,
      question:
        "What is the solution to the quadratic equation ax² + bx + c = 0?",
      options: [
        "x = (-b ± √(b² - 4ac))/2a",
        "x = -b/a",
        "x = -c/b",
    ...
    },
    {
      ...
      options: [
        "A function with no gaps or breaks",
        "A function that is differentiable everywhere",
